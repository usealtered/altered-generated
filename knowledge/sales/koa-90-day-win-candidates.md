---
title: Koa landing hero — 90-day win candidates
---

# Koa landing hero — 90-day win candidates

Read-only extract from `usealtered/altered` (2026-08-11). Sources: `.context/strategy-generated/frameworks/OFFER.md`, `SETTLEMENTS.md` (S2, S21, S25, S35, S41), landing stub. Not invented — grounded in locked settlements.
...
2. **Ninety days from now, you stop re-deriving hard-won conclusions under crunch - Koa resurfaces your best thinking before the restart begins.**
   - Rationale: OFFER.md WHY (re-derive conclusions / scatter) + "redundant thinking" pain + locked mechanism verb "resurfaces".

3. **Ninety days from now, unfinished shipping stops resetting your momentum - aligned progress compounds because direction stops drifting.**
   - Rationale: S25 lead outcome (aligned progress: speed, rate, direction toward shipping with fewest switch-ups) + S41 completion framing + unfinished-shipping ICP pain.
